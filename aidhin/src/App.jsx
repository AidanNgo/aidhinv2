...
function App() {
  ...
  return (
    <>
      {/* Renders nothing: it puts every new page at the top, which a
          client-side navigation otherwise leaves to chance. Outside
          <Routes> so it survives the swap and sees every change. */}
      <ScrollToTop />
